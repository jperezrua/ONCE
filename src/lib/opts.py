...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='coco_base',
                                 help='coco | coco_base | kitti | coco_hp | pascal')
        ...
        self.parser.add_argument('--supp_ctxt', type=int, default=7,
                                 help='Number of pixel to add to each side of the support boxes')
        self.parser.add_argument('--ep_test', type=int, default=1,
                                 help='Number of per-class heatmaps to use during episodic testing')
        ...
        self.parser.add_argument('--coco_eval_novel_only', action='store_true',
                                 help='use ground truth depth.')
        self.parser.add_argument('--fewshot_data', type=str,
                                 help='all_data (B+N) | novel_only | basenovel_fewshot | base_only ')
        self.parser.add_argument('--use_softmax', action='store_true')

        self.parser.add_argument('--code_debug', default=False, action="store_true")
