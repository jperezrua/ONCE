################# COCO FULL RES-18
python main.py ctdet --exp_id coco_res18 --arch res_18 --batch_size 114 --master_batch 18 --lr 5e-4 --gpus 0,1,2,3 --num_workers 16 --head_conv 0
...
################ COCO BASE RES-101
python main.py ctdet --exp_id coco_base_res101_nohc --arch res_101 --batch_size 84 --master_batch 5 --lr 3.75e-4 --gpus 0,1,2,3,4,5,6,7 --num_workers 16 --dataset coco_base --head_conv 0
