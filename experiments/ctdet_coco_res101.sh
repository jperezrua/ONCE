...
# for cbb on all the base classes
python main.py ctdet --exp_id coco_res101_nohc --arch res_101 --batch_size 96 --master_batch 5 --lr 3.75e-4 --gpus 0,1,2,3,4,5,6,7 --num_workers 16 --dataset coco_base --head_conv 0
